package WEB_JSP_Servlet.web_JSP.src.main.java.hr.dao;
...
public class DepartmentDao {
    ...
    private WEB_JSP_Servlet.web_JSP.src.main.java.helper.JdbcTemplate JdbcTemplate;
    ...
    public DepartDetailDto getDepartmentDetail(int deptId) {
        String sql = """
                ...
                """;
        // sql문 종료시 ';' 붙이면 안됨. sqldeveloper에서만 ';'붙이기
