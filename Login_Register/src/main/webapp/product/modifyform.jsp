    ...
    <div class="row">
        <div class="col-12">
            ...
            <%
                ...
                //				cat =ProductCategory[no=번호 name =카테고리명]
                //				company = Company[no=번호 name =회사명 tel=null city=null]
                //				status=ProductStatus[no=번호 name=상태명]
            ...
            <form class="border bg-light p-3"
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-select" name="catNo">
                        ...
                        %>
                        <option value="<%=cat.getNo() %>" <%=cat.getNo() == product.getCat().getNo() ? "selected"
                                : "" %> ><%=cat.getName() %>
                        </option>
                        <%
                            }
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-select" name="comNo">
                        ...
                        %>
                        <option value="<%=comp.getNo() %>"<%=comp.getNo() == product.getCompany().getNo() ? "selected"
                                : "" %> ><%=comp.getName() %>
                        </option>
                        <%
                            }
                ...
                <div class="form-group mb-3">
                    ...
                    <div>
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="statusNo"
                                   value="<%=status.getNo() %>" <%= status.getNo() == product.getStatus().getNo() ? "checked" : "" %> >
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea rows="3" class="form-control" name="description"><%=product.getDescription()%>
					</textarea>
                </div>
                <div class="form-group mb-3">
                    ...
                    <div>
                        ...
                        %>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="eventNo"
                                   value="<%=event.getNo() %>" <%=product.hasEvent(event.getNo()) ? "checked" : "" %> >
