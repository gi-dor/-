        ...
        <div class="col-12">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <th>상태</th>
                    <td><%=product.getStatus().getName() %>
                    </td>
                </tr>
                <tr>
                    <th>등록일자</th>
                    <td><%=DateUtils.toText(product.getCreatedDate()) %>
                    </td>
                    <th>수정일자</th>
                    <td><%=DateUtils.toText(product.getUpdatedDate()) %>
                    </td>
                </tr>
                <tr>
                    <th>이벤트내용</th>
